...
SEXP nro_coalesce_network(SEXP data_R, SEXP vars_R, SEXP cutoff_R);
SEXP nro_coalesce_prune(SEXP tails_R, SEXP heads_R, SEXP weights_R, SEXP degree_R);
SEXP nro_coalesce_split(SEXP tails_R, SEXP heads_R, SEXP weights_R);
...
R_CallMethodDef callMethods[]  = {
  ...
  {"nro_coalesce_network", (DL_FUNC) &nro_coalesce_network, 3},
  {"nro_coalesce_prune", (DL_FUNC) &nro_coalesce_prune, 4},
  {"nro_coalesce_split", (DL_FUNC) &nro_coalesce_split, 3},
