...
unadjusted data as input `data = dataset` but the evaluation is done via the
adjusted model:
...
subgroups is easier to interpret in relation to what you would see when
meeting the actual real-world participants.
